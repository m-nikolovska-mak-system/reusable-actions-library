...
**File:** [`.github/workflows/assign-jira-issue.yml`](https://github.com/m-nikolovska-mak-system/reusable-actions-library/blob/main/.github/workflows/assign-jira-issue.yml) — Reusable workflow to safely assign a Jira issue to a user with email validation and assignable check.
