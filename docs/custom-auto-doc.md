...
# 📝 Auto-Generate Workflow Documentation — Reusable Workflow
...
* Creating documentation pages if they don’t already exist
...
* 📄 Newly created or updated workflow documentation
* 🔁 Automatic pull requests containing the updates
...
| --------------- | ------ | --------- | ------------------------------------------------------ | ----------------------------------- |
| `template_path` | string | ✅ YES     | Path to the README template used when generating pages | `.github/docs/workflow-template.md` |
| `python_script` | string | ✅ YES     | Script that reads workflow YAML and outputs Markdown   | `.github/scripts/generate-docs.py`  |
| `branch_prefix` | string | ❌ No      | Prefix for auto-generated PR branches                  | `auto-doc/update-readme`            |
